# -*- coding: utf-8 -*-
# Generated by Django 1.11.27 on 2020-02-05 04:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(db_index=True, help_text='The learner email domain e.g. "example.com".', max_length=255)),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course_access_groups.CourseAccessGroup')),
            ],
            options={
                'abstract': False,
