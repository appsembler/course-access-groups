...
#
# html_title = 'course-access-groups v0.1.0'
...
def on_init(app):
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'course_access_groups'),
                os.path.join(root_path, 'course_access_groups/migrations')])
